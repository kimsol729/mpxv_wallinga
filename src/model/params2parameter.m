...
switch behavioral_adaptation_
    ...
    case 'july'
        ...
        params_ba = {'med_inf_1', 6.05, false, 'Days infectious not refraining from sex, before T2'
            ...
            'dec_c_12_T2', 0.13, false, 'Percentage reduction in casual partners, (very-fairly)low activity groups, after T2'
            'dec_c_3_T2', 0.15, false, 'Percentage reduction in casual partners, fairly high activity group, after T2'
            'dec_c_4_T2', 0.24, false, 'Percentage reduction in casual partners, very high activity group, after T2'};
...
params_progression = {'mu', 1 / 50 / 365 * dt_ , false, '$\mu$'
    'mu_d', 0.0004 / dt_ , false, '$\mu_d$'
    'theta', 1 / med_lat_ * dt_ , false, '$\theta$'
    'delta1',  1 / med_inf_1_ * dt_ , false, '$\delta_1$'
    'delta2',  1 / med_inf_2_ * dt_ , false, '$\delta_2$'
    'gamma1', 1 / (med_inf_ - med_inf_1_) * dt_ , false, '$\gamma_1$'
    'gamma2', 1 / (med_inf_ - med_inf_2_) * dt_ , false, '$\gamma_2$'
